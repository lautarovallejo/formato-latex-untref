...
\usepackage{hyperref} %para que las url sean hipervínculos
\hypersetup{ %formato de url (texto en azul y sin bordes)
	colorlinks = true,
	linkcolor = black,
	anchorcolor = black,
	citecolor = black,
...
\urlstyle{same} %previene que la url tenga otro formato
\renewbibmacro{in:}{}
